...
GLOSSARY_DEFINITIONS = [
    ...
    ("<strong>OpenAI API, API key, and SDK:</strong>", "glossary-openai-api"),
    ...
    ("<strong>Top-1 accuracy, MRR, and ROC-AUC:</strong>", "glossary-retrieval-metrics"),
    (
        "<strong>parallel句、intertextuality、cross-linguistic semantic textual similarity：</strong>",
        "glossary-parallel-intertextuality",
    ),
    (
        "<strong>Parallel passages, intertextuality, and cross-linguistic semantic textual similarity:</strong>",
        "glossary-parallel-intertextuality",
    ),
    ("<strong>manifest、JSON、HTML：</strong>", "glossary-formats"),
    ("<strong>Manifest, JSON, and HTML:</strong>", "glossary-formats"),
