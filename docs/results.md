...
| top-k | Observed mixing | Rank among 55 pairs | Label-shuffle mean | 95% range |
| ---: | ---: | ---: | ---: | --- |
...
- 一方、ラベルシャッフル平均は観測値より高い。これは混合率が「ランダムにラベルが混ざるほど高くなる」指標であるためで、通常の「観測値がランダムより高い」検定としては読めない。
